---
title: "종이 포장 접착제 가이드 — 포리졸부터 방수 D4 등급까지"
date: 2026-04-28T12:15:00+09:00
draft: false
tags: ["접착제", "포리졸", "PVAc", "PUR", "방수접착제", "EN 204", "포장소재"]
categories: ["포장소재"]
summary: "한국 포장 현장에서 가장 많이 쓰이는 포리졸(PVAc)의 한계와 방수가 필요한 환경에서 사용하는 가교형·PUR 접착제까지, EN 204 등급 체계로 정리한다."
translationKey: "paper-packaging-adhesive-waterproof"
cover:
  image: ../images/posts/paper-packaging-adhesive-waterproof/cover.png
  alt: "종이 포장재용 접착제 종류와 방수 등급"
  relative: false
---
![종이 포장재용 접착제 종류와 방수 등급](../images/posts/paper-packaging-adhesive-waterproof/cover.png)
...
- **고온 한계** — 60℃ 이상에서 연화
- **EN 204 등급** — 표준 D1~D2 수준 (실내·건조 환경)
...
![접착제 종류별 적용 환경 비교](../images/posts/paper-packaging-adhesive-waterproof/img-01.png)
...
- **단점**: 단가 높음 (PVAc 대비 3~5배), 전용 설비 필요
- **적용**: 고급 수출 포장, 식품 직접 접촉 라미네이션, 가구·자동차 부품 포장
- **특성**: 경화 후 D4 이상, 80~100℃까지 안정
...
![접착제 종류별 성능 매트릭스](../images/posts/paper-packaging-adhesive-waterproof/img-02.png)

| 항목 | 포리졸(PVAc) | 가교 PVAc | EVA 핫멜트 | PUR 핫멜트 | PUD |
|------|-------------|----------|-----------|-----------|-----|
| 단가 | ★ (가장 저렴) | ★★ | ★★ | ★★★★ | ★★★ |
| 방수 (EN 204) | D1~D2 | D3~D4 | D2 | D4+ | D4 |
| 내열성 | ~60℃ | ~70℃ | ~80℃ | ~100℃ | ~80℃ |
...
단가가 PVAc 대비 3~5배 비싸고, 전용 도포 장비(가열식 노즐, 밀폐 카트리지)가 필요해서 진입 비용이 높습니다. 또한 PUR은 수분에 반응해 경화하므로 보관·취급 조건이 까다롭습니다.
